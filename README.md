...
- SPRING_AI_OLLAMA_BASE_URL — Spring AI base URL. Default: http://localhost:11434 (property key:
  spring.ai.ollama.base-url)
- OLLAMA_BASE_URL — Feign client base URL for the remote chat implementation. Default: https://ollama.com (property key:
  ollama.base-url)
...
1) Clone repository and configure environment variables (see above). At minimum, set OPEN_API_KEY and BOT_TOKEN to
   enable both REST and Telegram features.
...
- For remote chat (IMPL=remote), you can override OLLAMA_BASE_URL (defaults to https://ollama.com). Example: -e
